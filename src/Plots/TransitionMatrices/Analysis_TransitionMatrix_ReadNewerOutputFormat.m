...
model = 5; % 1 = stiffening, 2 = stiffening full range, 3 = multiple binding, 4 = multiple binding ibEqual
...
switch (model)
    ...
    case 2
        ...
        % save transition matrices location
        transitionMatrixfolder    = '~/Documents/Papers/MultisiteDisorder/Data/1.LocalStructuring/';
        transitionMatrixsubfolder = [iSiteSpacing,'/Membrane',membraneState,'/2.TransitionMatrices/FullRangeStiffness/'];
...
%     end
    ...
    POcc(:,1:locationTotal) = M(:,16+7*(0:1:locationTotal-1));
